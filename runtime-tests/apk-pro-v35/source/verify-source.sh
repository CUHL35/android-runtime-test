...
grep -q "targetSdk 31" app/build.gradle || fail "targetSdk != 31"
grep -q "versionCode 35" app/build.gradle || fail "versionCode != 35"
grep -q "versionName '35'" app/build.gradle || fail "versionName != 35"
